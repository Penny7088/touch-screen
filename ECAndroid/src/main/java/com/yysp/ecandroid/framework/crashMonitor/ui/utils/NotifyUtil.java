package com.yysp.ecandroid.framework.crashMonitor.ui.utils;
...
//                requestCode, intent, FLAG);
     ...
     * @param content
     */
    public void notify_normal_singline(PendingIntent pendingIntent,
                                       int smallIcon,
                                       String ticker,
                                       String title,
                                       String content,
...
//        }).start();
    ...
    public void notify_HeadUp(PendingIntent pendingIntent,
                              int smallIcon,
                              int largeIcon,
                              String ticker,
                              String title,
                              ...
                              int leftbtnicon,
                              String lefttext,
                              PendingIntent leftPendingIntent,
